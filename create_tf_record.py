...
Usage:
  create_tf_record [options]

Options:
--dataset_dir          Your dataset directory
--validation_size      The proportion of examples in the dataset to be used for validation
--num_shards           Number of shards to split the TFRecord files
--random_seed          Random seed to use for repeatability.
--tfrecord_filename    The output filename to name your TFRecord file
'''
...
flags = tf.app.flags
flags.DEFINE_string('dataset_dir', "./bismillah-bisa-ya-allah/", 'String: Your dataset directory')
...
flags.DEFINE_string('tfrecord_filename', 'algolux', 'String: The output filename to name your TFRecord file')
FLAGS = flags.FLAGS
